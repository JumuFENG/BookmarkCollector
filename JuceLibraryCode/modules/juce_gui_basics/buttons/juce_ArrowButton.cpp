   ...
   : Button (name), colour (arrowColour)
{
    ...
    direction = arrowDirectionInRadians;
}
...
void ArrowButton::changeDirectionTo(float arrowDirection)
{
    path.applyTransform(AffineTransform::rotation ( - float_Pi * 2.0f * direction, 0.5f, 0.5f));
    direction = arrowDirection;
    path.applyTransform(AffineTransform::rotation (float_Pi * 2.0f * arrowDirection, 0.5f, 0.5f));
}
